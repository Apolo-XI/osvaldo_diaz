...
public interface RegistrarApi {
    ...
    @ApiOperation(value = "Registro ofertas", nickname = "registrarPost", notes = "Registro de ofertas", response = JsonApiBodyResponseSuccess.class, tags={ "ofertas", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "OFERTA REGISTRADO CORRECTAMENTE.", response = JsonApiBodyResponseSuccess.class),
